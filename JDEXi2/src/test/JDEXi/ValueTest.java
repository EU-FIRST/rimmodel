...
public class ValueTest extends TestCase {
    public void testValueTest() {
        String name = "JP1";
        Integer ordinal = new Integer(1);

        Value value = new Value(name, ordinal);
        assertEquals("Invalid name value", name, value.getName());
        assertEquals("Invalid ordinal value", ordinal, value.getOrdinal());
    }
}
